export const UI = {
    ...
    showMenu(mode = 'both', showClose = true) {
        ...
        if (this.elements.closeOverlayBtn) {
            this.elements.closeOverlayBtn.style.display = showClose ? 'block' : 'none';
        }

        const instructionsPanel = this.elements.menuOverlay.querySelector('.instructions-panel');
        const difficultyPanel = this.elements.menuOverlay.querySelector('.difficulty-panel');
